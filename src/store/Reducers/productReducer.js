...
export const get_products = createAsyncThunk(
    ...
    async({perPage, page, searchValue}, {rejectWithValue, fulfillWithValue}) => {
        try {
            const {data} = await api.get(`/get-products?page=${page}&&searchValue=${searchValue}&&perPage=${perPage}`, {
                withCredentials: true
            })
            console.log(data);
...
export const product_image_update = createAsyncThunk(
    ...
    async({oldImage, newImage, productId}, {rejectWithValue, fulfillWithValue}) => {
        try {
            ...
            const {data} = await api.put('/product-image-update', formData, {
                withCredentials: true
            })
            console.log(data);
...
export const productReducer = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        .addCase(get_single_product.fulfilled, (state, {payload}) => {
