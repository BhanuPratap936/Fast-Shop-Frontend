                ...
                <div className="w-full md:w-6/12">
                    <div className="w-full p-4 bg-[#6a5fdf] rounded-md text-[#d0d2d6]">
                        <div className="flex justify-center items-center py-3">
                            {
                                userInfo?.image ? <label htmlFor="img" className="h-[150px] w-[200px]
                                ...
                                flex-col h-[150px] w-[280px] cursor-pointer border
                                border-dashed hover:border-red-500 border-[#d0d2d6] relative" htmlFor="img">
                            ...
                            <input onChange={add_image} type="file" name="" className="hidden" id="img" />
                        </div>
                        ...
                        <div className="px-0 md:px-5 py-2">
                            ...
                            bg-slate-800 rounded-md relative">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <p>
                                        {
                                            status === 'active' ? <span className="bg-red-500 text-white text-xs
                                            cursor-pointer font-normal ml-2 px-2 py-0.5 rounded">
                                                {userInfo.payment}
                                            </span> : <span className="bg-blue-500 text-white text-xs
                                            cursor-pointer font-normal ml-2 px-2 py-0.5 rounded">
                                                Click Active
                                            </span>
                                        }
                        ...
                        <div className="px-0 md:px-5 py-2">
                            {
                                !userInfo?.shopInfo ? <form onSubmit={add}>
                                    <div className="flex flex-col w-full gap-1 mb-2">
                                        ...
                                        <input value={state.shopName} onChange={inputHandle} className="px-4 py-2 focus:border-indigo-500 outline-none
                    bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]"
                                    ...
                                    <div className="flex flex-col w-full gap-1 mb-2">
                                        ...
                                        <input value={state.division} onChange={inputHandle} className="px-4 py-2 focus:border-indigo-500 outline-none
                    bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]"
                                            type="text" name="division" id="division" placeholder="Division Name" />
                                    </div>

                                    <div className="flex flex-col w-full gap-1 mb-2">
                                        <label htmlFor="division">District Name</label>
                                        <input value={state.district} onChange={inputHandle} className="px-4 py-2 focus:border-indigo-500 outline-none
                    bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]"
                                    ...
                                    <div className="flex flex-col w-full gap-1 mb-2">
                                        ...
                                        <input value={state.sub_district} onChange={inputHandle} className="px-4 py-2 focus:border-indigo-500 outline-none
                    bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]"
                ...
                <div className="w-full md:w-6/12">
                    ...
                    bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]"
                                ...
                                <div className="flex flex-col w-full gap-1 mb-2">
                                    ...
                                    <input className="px-4 py-2 focus:border-indigo-500 outline-none
                    bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]"
                                        type="text" name="old_password" id="o_password" placeholder="Old Password" />
                                </div>
                                ...
                                <div className="flex flex-col w-full gap-1 mb-2">
                                    ...
                                    <input className="px-4 py-2 focus:border-indigo-500 outline-none
                    bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]"
                                        type="text" name="new_password" id="n_password" placeholder="New Password" />
                                </div>
