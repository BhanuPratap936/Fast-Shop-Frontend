...
const Payments = () => {
    ...
    <div className='w-[25%] p-2 whitespace-nowrap'>₹4568</div>
                <div className='w-[25%] p-2 whitespace-nowrap'>
                    <span className='py-[1px] px-[5px] bg-slate-300 text-blue-700
                    rounded-md text-sm'>Pending</span>
                </div>
                <div className='w-[25%] p-2 whitespace-nowrap'> 09 Dec 2024</div>
        ...
        <div className="px-2 md:px-7 py-5">
            ...
            md:grid-cols-2 lg:grid-cols-4 gap-7 mb-5">
                ...
                rounded-md gap-3">
                    ...
                    text-[#5c5a5a]">
                        <h2 className="text-2xl font-bold">₹796K</h2>
                    ...
                    flex justify-center items-center text-2xl">
                        <HiOutlineCurrencyRupee className="text-[#fae8e8] shadow-lg" />
                    </div>
                </div>
                ...
                rounded-md gap-3">
                    <div className="flex flex-col justify-start items-start
                    text-[#5c5a5a]">
                        <h2 className="text-2xl font-bold">₹45k</h2>
                ...
                rounded-md gap-3">
                    <div className="flex flex-col justify-start items-start
                    text-[#5c5a5a]">
                        <h2 className="text-2xl font-bold">₹195k</h2>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-2 pb-4">
                    ...
                    <div className="pt-5 mb-5">
                        <form>
                            <div className="flex gap-3 flex-wrap">
                                <input min='0' type="number" className="px-3
                                py-2 md:w-[75%] focus:border-indigo-200 outline-none
                ...
                <div className="bg-[#6a5fdf] text-[#d0d2d6] rounded-md p-5">
                    <h2 className="text-lg mb-5">Successful Withdrawal</h2>
