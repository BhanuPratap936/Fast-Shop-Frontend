...
const AddProduct = () => {
    ...
    const addProduct = (e) => {
        ...
        formData.append('shopName', 'Mr. Robot')
                    ...
                    bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]" onChange={inputHandle} value={category}
                                ...
                                <div className={`absolute top-[101%] bg-[#475569] w-full
                                    ...
                                    <div className="flex justify-start items-start
                                        ...
                                        {
                                            allCategory.map((c, i) => <span key={i}
                        ...
                        sm:gap-4 md:gap-4 gap-3 w-full text-[#d0d2d6] mb-4">
                            {
                                imageShow.map((img, i) => <div key={i} className="h-[180px] relative">
                                    <label htmlFor={i}>
                                        <img className="w-full h-full rounded-md" src={img.url} alt="" />
                                    </label>
                                    <input onChange={(e) => changeImage(e.target.files[0], i)} type="file"
                                        id={i} className="hidden" />
                                    <span onClick={() => removeImage(i)} className="p-2 z-10 curosr-pointer bg-slate-700 hover:shadow-lg
                                    hover:shadow-slate-400/50 text-white absolute top-1
                                    right-1 rounded-full"><IoMdCloseCircle /></span>
                                </div>)
                            }
