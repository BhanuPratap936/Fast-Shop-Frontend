...
const AdminDashboard = () => {
    ...
    const state = {
        series: [
            {
                name: "Orders",
                data: [23, 45, 67, 15, 34, 65, 24, 43, 21, 59, 72, 34]
            },
            {
                name: "Revenue",
                data: [76, 35, 27, 32, 34, 65, 14, 53, 31, 81, 69, 55]
            },
            {
                name: "Sellers",
                data: [63, 25, 17, 35, 24, 55, 24, 49, 29, 21, 22, 45]
            }
        ],
        options: {
            color: ['#181ee8', '#181ee8'],
        ...
        <div className="px-2 md:px-7 py-5">
            ...
            md:grid-cols-2 lg:grid-cols-4 gap-7">
                ...
                rounded-md gap-3">
                    ...
                    text-[#5c5a5a]">
                        <h2 className="text-3xl font-bold">₹796K</h2>
                        <span className="text-md font-medium">Total Sales</span>
                    </div>

                    <div className="w-[40px] h-[47px] rounded-full bg-[#fa0305]
                    flex justify-center items-center text-xl">
                        <TbReceiptRupee className="text-[#fae8e8] shadow-lg" />
                    </div>
                </div>
                ...
                rounded-md gap-3">
                    ...
                    flex justify-center items-center text-xl">
                        <FaUsersRectangle className="text-[#fae8e8] shadow-lg" />
                    </div>
                </div>
                ...
                rounded-md gap-3">
                    ...
                    flex justify-center items-center text-xl">
                        <IoMdCart className="text-[#fae8e8] shadow-lg" />
                    </div>
                </div>
            </div>
                        ...
                        <div className="flex flex-col gap-2 pt-6 text-[#d0d2d6]">
                            <ol className="relative border-1 border-slate-600 ml-4">
                                <li className="mb-3 ml-6">
                                    <div className="flex absolute -left-5 shadow-lg justify-center items-center w-10 h-10 p-[6px] 
                                    bg-[#4c7fe2] rounded-full z-10">
                                        <img className="w-full rounded-full h-full shadow-lg" src="http://localhost:3000/images/admin.jpg" alt="admin-icon" />
                                    </div>
            ...
            <div className="w-full p-4 bg-[#6a5fdf] rounded-md mt-6">
                ...
                <div className="relative overflow-x-auto">
                    <table className="w-full text-sm text-left text-[#d0d2d6]">
                        ...
                        <tbody>
                            {
                                [1,2,3,4,5].map((_, i) => <tr key={i}>
                                <td className="py-3 px-4 font-medium
                                whitespace-nowrap">#65432</td>
                                <td className="py-3 px-4 font-medium
                                whitespace-nowrap">₹5000</td>
                                <td className="py-3 px-4 font-medium
