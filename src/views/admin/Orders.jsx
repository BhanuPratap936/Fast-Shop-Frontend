                ...
                <div className="w-full text-sm text-left text-[#d0d2d6]">
                    ...
                    <div className="text-[#d0d2d6]">
                        ...
                        <div className="flex justify-between items-start border-b border-slate-700">
                            <div className="py-3 w-[25%] font-medium whitespace-nowrap">#7659</div>
                            <div className="py-3 w-[13%] font-medium">₹4500</div>
                        ...
                        <div className={show ? 'block boder-b border-slate-700 bg-[#8288ed]': 
                            'hidden'
                        }>
